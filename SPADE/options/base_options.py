...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='coco_pretrained', help='name of the experiment. It decides where to store samples and models') # default='label2coco'

        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/home/bernihoh/Bachelor/SPADE/checkpoints/', help='models are saved here')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/home/bernihoh/Bachelor/SPADE/datasets/coco_stuff/')
