...
class MetricBase:
    ...
    def get_result_str(self):
        ...
        result_str += ' time %-12s' % util.format_time(self._eval_time)
    ...
    def _report_progress(self, pcur, pmax, status_str=''):
        ...
        RunContext.get().update(status_str, int(val), self._progress_max)
...
class MetricGroup:
    def __init__(self, metric_kwarg_list):
        self.metrics = [util.call_func_by_name(**kwargs) for kwargs in metric_kwarg_list]
